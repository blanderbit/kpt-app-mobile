...
import {Button, View, Text, Alert, Linking, Platform} from "react-native";
...
export default function GoogleSignInButton() {
    ...
    const [request, response, promptAsync] = Google.useAuthRequest({
            ...
            clientId: Platform.select({
                ios: '1015243991043-tf5f0n2gsv8c8t28635v9rhv7j7rsg6a.apps.googleusercontent.com',
                // android: "ANDROID_CLIENT_ID.apps.googleusercontent.com",
                web: "78984716511-4fdfc5l4afgtag2hsbn3puvllmfc1v4h.apps.googleusercontent.com"
            }),

            responseType: "id_token",
            scopes: ['profile', 'email'],
            redirectUri: AuthSession.makeRedirectUri({ scheme: 'kpt-apple' }),
        ...
        // clientId: Platform.select({
        //     ios: '78984716511-v1qg9hahti25vjvgmi72bcbov49fkcql.apps.googleusercontent.com',
        //     android: '78984716511-6u49n9quctr938qbdph6ffo4hi4redeb.apps.googleusercontent.com',
        //     web: "78984716511-4fdfc5l4afgtag2hsbn3puvllmfc1v4h.apps.googleusercontent.com"
        // }),
